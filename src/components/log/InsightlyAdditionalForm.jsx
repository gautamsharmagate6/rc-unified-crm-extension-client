    ...
    useEffect(() => {
        if(additionalFormInfo != null)
        {
            setSubmission({
                ...
                organization: additionalFormInfo.links.filter(f => f.label === 'Organisation')[0]?.id,
                opportunity: additionalFormInfo.links.filter(f => f.label === 'Opportunity')[0]?.id,
                project: additionalFormInfo.links.filter(f => f.label === 'Project')[0]?.id
            });
